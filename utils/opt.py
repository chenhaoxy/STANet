...
class Options:
    ...
    def _initial(self):
        ...
        #                     General options
        # ===============================================================
        self.parser.add_argument('--data_dir', type=str, default=r'E:\\NTUdataset\h3.6m_position\dataset/', help='path to H36M dataset')
        self.parser.add_argument('--data_dir_3dpw', type=str, default=r'E:\\NTUdataset\3dpw\sequenceFiles/', help='path to 3DPW dataset')
        self.parser.add_argument('--data_dir_cmu', type=str, default='E:\cmudataset', help='path to CMU dataset')
        self.parser.add_argument('--exp', type=str, default=R'E:\\CODE\model_cmu', help='ID of experiment')#H:\whz\CODE\model_3dpw
