...
import utils.forward_kinematics as fk#   import forward_kinematics as fk
...
class Ax3DPose(object):
    def __init__(self, ax, lcolor="#3498db", rcolor="#e74c3c", label=['GT', 'Pred']):
        ...
        # self.I = np.array([1, 2, 21, 3, 19, 18, 17, 1, 13, 14, 11, 10, 9, 21, 5, 6]) - 1
        # self.J = np.array([2, 21, 3, 4, 18, 17, 1, 13, 14, 15, 10, 9, 21, 5, 6, 7]) - 1
        self.I = np.array([1, 2, 3, 1, 7, 8, 1, 13, 14, 15, 14, 18, 19, 14, 26, 27]) - 1
